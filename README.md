...
# Hey, it’s Zinet Kemal

**Senior Cloud Security Engineer | AI Security & Governance | TEDx Speaker | Author | Instructor**

I’m a cybersecurity professional specializing in **cloud security, AI security, and governance**, with experience securing enterprise cloud multi cloud environments.
...
`AI Security` • `Agentic AI` • `MITRE ATLAS` • `OWASP LLM & Agentic Security` • `NIST AI RMF` • `AWS Security` • `Azure Security`

## Beyond Engineering

I’m a **TEDx speaker, cybersecurity books author, and linkedin learning and adjunct instructor** passionate about cybersecurity education, online safety, and helping the next generation see themselves in cybersecurity.

## Connect With Me

[Website](https://www.zinetkemal.com) | [LinkedIn](https://www.linkedin.com/in/zinetkemal/)
---
